...
*
*/
public class GetFile2 extends Thread {
    ...
    * @抛出异常的原因是无法绑定服务的端口
    * */
    public GetFile2(int port,String filePath) throws Exception {
        try {
            // 绑定服务的端口
...
//            System.out.println("接收完毕!");
    ...
    */
    public static void main(String args[]) {
        GetFile2 getFile = null;
        try {

            getFile = new GetFile2(20000,"D:\\abc.e");
